<?php namespace Carbontwelve\BloggyKernel\Models\Classification\TaxonRelationship\Eloquent;
/**
* --------------------------------------------------------------------------
...
use Carbontwelve\BloggyKernel\Models\Classification\TaxonRelationship\ProviderInterface;

/**
 * Class TaxonRelationshipProvider
 * @package Carbontwelve\BloggyKernel\Models\Classification\TaxonRelationship\Eloquent
 */
class TaxonRelationshipProvider implements ProviderInterface {
     ...
     * @var string
     */
    protected $model = 'Carbontwelve\BloggyKernel\Models\Classification\TaxonRelationship\Eloquent\TaxonRelationship';
     ...
     *
     * @throws TaxonRelationshipNotFoundException
     * @param  int  $id
