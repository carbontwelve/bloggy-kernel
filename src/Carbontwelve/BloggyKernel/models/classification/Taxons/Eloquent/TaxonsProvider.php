<?php namespace Carbontwelve\BloggyKernel\Models\Classification\Taxons\Eloquent;
/**
* --------------------------------------------------------------------------
* Taxons Eloquent Provider
* --------------------------------------------------------------------------
*
...
use Carbontwelve\BloggyKernel\Models\Classification\Taxons\ProviderInterface;

/**
 * Class TaxonsProvider
 * @package Carbontwelve\BloggyKernel\Models\Classification\Taxons\Eloquent
 */
class TaxonsProvider implements ProviderInterface {
     ...
     * @var string
     */
    protected $model = 'Carbontwelve\BloggyKernel\Models\Classification\Taxons\Eloquent\Taxons';
    ...
    public function findByID($id = null)
    {
        ...
        {
            throw new TaxonsNotFoundException("A taxons could not be found with ID [$id].");
        }
        return $board;
    }
